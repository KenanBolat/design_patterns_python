...
class Address:
    ...
    def __str__(self):
        return f'Street nnumbers : {self.street_address},  Suite : {self.suite} , City  : {self.city}'
...
class EmployeeFactory:
    main_office_employee = Employee('', Address('123 Easet Dr', 0, 'London'))
    aux_office_employee = Employee('', Address('123BB Easet Dr', 0, 'London'))
